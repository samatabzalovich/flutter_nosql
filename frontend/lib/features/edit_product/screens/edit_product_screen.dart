...
import '../../add_product/widgets/custom_textfield.dart';
...
class _EditProductState extends ConsumerState<EditProduct> {
  ...
  updateProduct(BuildContext context, List<String> urls, String id) {
    print(_productColors);

    if (_addProductFormKey.currentState!.validate()) {
      ref.read(homeRepoProvider).updateProduct(
            id: id,
            context: context,
              ...
              children: [
                ...
                Container(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        updateProduct(context, product.images, product.id!);
                      },
